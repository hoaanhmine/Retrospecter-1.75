function onCreate()
	-- background shit
makeLuaSprite('bg', 'iceolation/1', -1200, -1420);
	addLuaSprite('bg', 'bg', false);
    scaleObject('bg', 1.2, 1.2) 
    
    makeAnimatedLuaSprite('aña', 'iceolation/nieve', -970, -550);
    addAnimationByPrefix('aña', 'aña', 'kamtro', 24, true);  
    objectPlayAnimation('aña', 'aña', true)
    addLuaSprite('aña', true);
    scaleObject('aña', 1.8, 1.8)  
